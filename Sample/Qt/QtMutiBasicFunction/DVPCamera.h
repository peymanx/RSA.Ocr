...
*-# Make good use of the "developer mode" of the official demo program. This helps to deepen the understanding of the functions and applications of each API interface<a href="C:/Program Files(x86)/Camera/BasedCam2">Basedcam2</a>
...
*@see dvpSetAeTarget
*@note The final brightness to be achieved by adjusting the exposure time and analog gain @link #dvpGetExposure @endlink鍜孈link #dvpGetAnalogGain @endlink
*/
